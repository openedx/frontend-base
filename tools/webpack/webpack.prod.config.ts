...
import NewRelicSourceMapPlugin from '@edx/new-relic-source-map-webpack-plugin';
...
import HtmlWebpackNewRelicPlugin from './plugins/html-webpack-new-relic-plugin';
